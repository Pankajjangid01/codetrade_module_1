...
class IntensiveCare(models.Model):
    ...
    patient_discharged = fields.Boolean(string="Discharged")
    patient_admitted = fields.Boolean(string="Admitted")
...
class MechnicalVentilation(models.Model):
    ...
    ventilation_duration = fields.Integer(string="Duration")
...
class ApacheScore(models.Model):
    ...
    registration_code = fields.Many2one('administration.administration',string="Registration Code")
    apache_age = fields.Integer(string="Age")
    apache_date = fields.Datetime(string="Date")
    apache_temprature = fields.Float(string="Temprature")
...
class IntensiveGcs(models.Model):
    ...
    registration_code = fields.Many2one('administration.administration',string="Registration Code")
    gec_eyes = fields.Char(string="Eyes")
    gcs_motor = fields.Char(string="Motor")
