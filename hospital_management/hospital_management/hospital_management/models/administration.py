    ...
    def _onchange_patient_id(self):
        ...
        for record in self:
            if record.patient_id:
                record.attending_physician = record.patient_id.patient_primary_care_doctor_id
                record.operating_physician = record.patient_id.patient_primary_care_doctor_id
            else:
