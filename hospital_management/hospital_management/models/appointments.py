...
class Appointments(models.Model):
    ...
    def validate_appointment_end_date(self):
        ...
        if self.physician and re.findall(r"[^a-zA-z][a-zA-z ]*", self.physician):
            raise ValidationError("Please enter a valid physician name.")
        
        if self.speciality and re.findall(r"[^a-zA-z][a-zA-z ]*", self.speciality):
            raise ValidationError("Please enter a valid speciality")
